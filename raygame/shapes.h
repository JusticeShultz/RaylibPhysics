...
bool checkCircleCircle(glm::vec2 posA, circle bircleA, glm::vec2 posB, circle circleB);
bool checkAABBAABB(glm::vec2 posA, aabb aabbA, glm::vec2 posB, aabb aabbB);
bool checkCircleAABB(glm::vec2 circlePos, circle circle, glm::vec2 aabbPos, aabb aabb);
